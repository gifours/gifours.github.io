...
const Header = () => {
  ...
  return (
    <header class="bg-transparent top-0 left-0 w-full flex items-center z-50 fixed">
        <div class="container">
            <div class="flex relative justify-normal lg:justify-between">
                ...
                <div class="flex items-center px-4">
                    <button id="hamburger" ref={hamburgerRef} name="hamburger" type="button" class={`hamburger ${isHamburgerActive ? 'hamburger-active' : ''} block absolute right-4 lg:hidden`}>
