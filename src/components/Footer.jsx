                ...
                <motion.div class="flex flex-wrap"  initial="offscreen" whileInView="onscreen" viewport={{ amount: 0.2 }} variants={cardVariants2}>
                    <div class="w-full px-4 lg:mb-12 text-slate-300 font-medium md:w-1/3">
                        <div class="flex pb-5">
                            ...
                            <div class="row-auto ml-5">
                                <h2 class="font-bold text-2xl text-white">Gifour</h2>
                                <h2 class="font-bold text-2xl text-white">Portofolio</h2>
                            </div>
                        </div>
                        <p>Gifour Portofolio merupakan salah satu produk yang dikembangkan oleh GifourProduction.</p>
                    </div>
                    <div class="w-full px-4 my-10 md:w-1/3 text-slate-300 font-medium">
                        <h3 class="font-bold text-2xl mb-2">Hubungi Saya</h3>
                        <p>taufiqadityaputra@gmail.com</p>
                        <p>Yogyakarta</p>
                    </div>
                    <div class="w-full my-auto pb-4 md:w-1/3">
                        <div class="flex flex-wrap mb-5 items-center justify-center">
                            {/* <!-- Whatsapp --> */}
                            <a href="https://wa.me/qr/N6JXGQNJ5JD6J1" class="sosmed">
                            ...
                            {/* <!-- Instagram --> */}
                            <a href="https://instagram.com/jasa.desain.jogja?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D" class="sosmed">
                            ...
                            {/* <!-- Tiktok --> */}
                            <a href="https://www.tiktok.com/@gifourproduction" class="sosmed">
                                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>TikTok</title>
                            ...
                            {/* <!-- Linkedin --> */}
                            <a href="https://www.linkedin.com/in/taufiq-aditya-putra-140402292/?originalSubdomain=id" class="sosmed">
                                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>LinkedIn</title>
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                            </a>
                            {/* <!-- Gmail --> */}
                            <a href="taufiqadityaputra@gmail.comd" class="sosmed">
